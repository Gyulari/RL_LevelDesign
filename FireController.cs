...
public class FireController : MonoBehaviour
{
    ...
    [SerializeField] private List<GameObject> collidedObjects = new();
    ...
    public void Fire()
    {
        ...
        if (enemy != null) {
            ...
            Debug.Log("No Enemy within Fire Range");
        }
    }
    ...
    private GameObject GetNearestEnemy(List<GameObject> collidedObjects)
    {
        ...
        foreach (GameObject obj in collidedObjects) {
            if (nearestDistance >= Vector3.Distance(transform.parent.position, obj.transform.position)) {
                nearestDistance = Vector3.Distance(transform.parent.position, obj.transform.position);
                nearestEnemy = obj;
            }
        }
